...
#include<string>
#include<array>
#include"include/serpenoid_sinus_lifting.h"
...
int main(){
    ...
    SnakeRobot snake(length_one_quarter, M_PI/4, M_PI/8);
    ...
    while(circumference<2*M_PI*r){
        ...
        //plt::xlim(-100, 100);
        //plt::ylim(0, 200);
        //plt::plot3(snake.C_x, snake.C_y, snake.C_z);
        //plt::plot3(orbit_x, orbit_y, orbit_z);
        //plt::legend();
        //plt::pause(0.01);
